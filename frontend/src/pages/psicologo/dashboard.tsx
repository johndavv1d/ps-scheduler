...
export default function DashboardPsicologo() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-4">Gerencie suas consultas e pareceres</p>
      <div className="mb-6">
        <EditarPerfil />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          ...
          <div className="space-y-4">
            {consultas.length === 0 ? (
              <p className="text-gray-500 dark:text-gray-400 text-center py-4">Nenhuma consulta agendada</p>
            ) : (
